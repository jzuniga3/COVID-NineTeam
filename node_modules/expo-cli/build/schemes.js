...
async function getManagedDevClientSchemeAsync(projectRoot) {
  ...
  try {
    ...
    _log().default.warn('\nDev Client: Unable to get the default URI scheme for the project. Please make sure the expo-dev-client package is installed.'); // throw new CommandError(error);
