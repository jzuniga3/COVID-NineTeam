...
function setSplashScreenLegacyMainActivity(config, mainActivity, language) {
  ...
  const LE = isJava ? ';' : '';
  mainActivity = _configPlugins().AndroidConfig.UserInterfaceStyle.addJavaImports(mainActivity, ['expo.modules.splashscreen.SplashScreen', 'expo.modules.splashscreen.SplashScreenImageResizeMode', 'android.os.Bundle'], isJava);
