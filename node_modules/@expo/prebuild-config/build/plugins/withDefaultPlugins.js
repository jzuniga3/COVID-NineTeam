...
function _expoBranch() {
  const data = _interopRequireDefault(require("./unversioned/expo-branch"));
...
function _expoFacebook() {
  const data = _interopRequireDefault(require("./unversioned/expo-facebook"));
...
const withAndroidExpoPlugins = (config, props) => {
  ...
  _configPlugins().AndroidConfig.JsEngine.withJsEngineGradleProps, // settings.gradle
